...
SELECT 'REL-DEMO-2026-0002', '明代印花罐', 'CERAMIC', 'CLAY', '明代', '征集购藏',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-11 11:14:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-11 12:44:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0005', '唐代累丝带扣', 'GOLD_SILVER_WARE', 'SILVER', '唐代', '社会捐赠',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-17 14:35:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-17 16:05:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0006', '清代楠木透雕屏风', 'WOOD', 'BAMBOO_WOOD', '清代', '社会捐赠',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-19 15:42:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-19 17:12:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0007', '明代戗金漆壶', 'LACQUER', 'LACQUER_WOOD', '明代', '社会捐赠',
  ...
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-21 09:49:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-21 11:19:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0008', '北齐莲花座立像', 'STONE', 'STONE', '北齐', '馆际移交',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-23 10:56:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-23 12:26:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0009', '宋代墨书册页', 'BAMBOO', 'BAMBOO_WOOD', '宋代', '馆际征集',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-25 11:03:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-25 12:33:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0011', '民国粉彩梅瓶', 'CERAMIC', 'PORCELAIN', '民国', '社会捐赠',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-29 13:17:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-29 14:47:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0014', '唐代錾刻带扣', 'GOLD_SILVER_WARE', 'SILVER', '唐代', '旧藏整理',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-04 09:38:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-04 11:08:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0015', '民国柏木髹漆供案', 'WOOD', 'WOOD', '民国', '寺院征集',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-06 10:45:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-06 12:15:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0016', '明代朱漆漆奁', 'LACQUER', 'LACQUER_WOOD', '明代', '旧藏移交',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-08 11:52:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-08 13:22:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0017', '宋代经幢供养人像', 'STONE', 'STONE', '宋代', '馆际移交',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-10 12:59:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-10 14:29:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0018', '汉代题记册页', 'BAMBOO', 'BAMBOO_WOOD', '汉代', '馆际征集',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-12 13:06:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-12 14:36:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0020', '宋代刻花盘', 'CERAMIC', 'CLAY', '宋代', '社会捐赠',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-16 15:20:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-16 16:50:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0023', '清代掐丝冠饰', 'GOLD_SILVER_WARE', 'GOLD', '清代', '馆际征集',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-22 11:41:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-22 13:11:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0024', '清代柏木髹漆香几', 'WOOD', 'WOOD', '清代', '寺院征集',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-24 12:48:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-24 14:18:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0025', '汉代描金漆盘', 'LACQUER', 'LACQUER_WOOD', '汉代', '社会捐赠',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-26 13:55:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-26 15:25:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0026', '北魏经幢供养人像', 'STONE', 'STONE', '北魏', '寺院征集',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-28 14:02:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-28 15:32:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0027', '宋代编联卷册', 'BAMBOO', 'BAMBOO_WOOD', '宋代', '学术移交',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-30 15:09:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-30 16:39:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0029', '清代影青碗', 'CERAMIC', 'CLAY', '清代', '征集购藏',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-03 10:23:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-03 11:53:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0032', '清代錾刻冠饰', 'GOLD_SILVER_WARE', 'SILVER', '清代', '旧藏整理',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-09 13:44:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-09 15:14:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0033', '民国楠木透雕佛像', 'WOOD', 'WOOD', '民国', '馆际调拨',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-11 14:51:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-11 16:21:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0034', '民国描金漆壶', 'LACQUER', 'LACQUER_WOOD', '民国', '旧藏移交',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-13 15:58:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-13 17:28:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0035', '唐代莲花座供养人像', 'STONE', 'STONE', '唐代', '寺院征集',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-15 09:05:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-15 10:35:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0036', '明代题记竹简', 'BAMBOO', 'BAMBOO_WOOD', '明代', '学术移交',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-17 10:12:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-17 11:42:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0038', '明代白釉盘', 'CERAMIC', 'PORCELAIN', '明代', '征集购藏',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-21 12:26:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-21 13:56:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0041', '宋代掐丝银盘', 'GOLD_SILVER_WARE', 'GOLD', '宋代', '馆际征集',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-27 15:47:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-27 17:17:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0042', '民国黄花梨经匣', 'WOOD', 'BAMBOO_WOOD', '民国', '社会捐赠',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-29 09:54:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-29 11:24:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0043', '汉代戗金漆盘', 'LACQUER', 'LACQUER_WOOD', '汉代', '社会捐赠',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-01 10:01:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-01 11:31:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0044', '宋代造像碑立像', 'STONE', 'STONE', '宋代', '馆际移交',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-03 11:08:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-03 12:38:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0045', '汉代编联木牍', 'BAMBOO', 'BAMBOO_WOOD', '汉代', '学术移交',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-05 12:15:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-05 13:45:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0047', '宋代影青罐', 'CERAMIC', 'CLAY', '宋代', '征集购藏',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-09 14:29:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-09 15:59:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0050', '清代累丝执壶', 'GOLD_SILVER_WARE', 'GOLD', '清代', '社会捐赠',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-15 10:50:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-15 12:20:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0051', '明代黄花梨经匣', 'WOOD', 'WOOD', '明代', '社会捐赠',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-17 11:57:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-17 13:27:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0052', '清代朱漆漆壶', 'LACQUER', 'LACQUER_WOOD', '清代', '征集购藏',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-19 12:04:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-19 13:34:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0053', '唐代造像碑坐像', 'STONE', 'STONE', '唐代', '考古发掘入藏',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-21 13:11:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-21 14:41:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0054', '明代简牍册页', 'BAMBOO', 'BAMBOO_WOOD', '明代', '考古发掘入藏',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-23 14:18:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-23 15:48:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0056', '清代白釉碗', 'CERAMIC', 'CLAY', '清代', '考古发掘入藏',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-27 09:32:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-27 11:02:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0059', '明代鎏金执壶', 'GOLD_SILVER_WARE', 'SILVER', '明代', '旧藏整理',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-02 12:53:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-02 14:23:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0060', '清代黄花梨佛像', 'WOOD', 'BAMBOO_WOOD', '清代', '社会捐赠',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-04 13:00:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-04 14:30:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0061', '明代黑漆漆奁', 'LACQUER', 'LACQUER_WOOD', '明代', '征集购藏',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-06 14:07:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-06 15:37:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0062', '北魏经幢坐像', 'STONE', 'STONE', '北魏', '寺院征集',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-08 15:14:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-08 16:44:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0063', '宋代题记木牍', 'BAMBOO', 'BAMBOO_WOOD', '宋代', '考古发掘入藏',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-10 09:21:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-10 10:51:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0065', '唐代粉彩罐', 'CERAMIC', 'PORCELAIN', '唐代', '社会捐赠',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-14 11:35:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-14 13:05:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0068', '明代掐丝执壶', 'GOLD_SILVER_WARE', 'SILVER', '明代', '馆际征集',
  'EXHIBIT_HALL_2', 'BASIC_COMPLETE', 'IN_STOCK', '二级', '干燥密闭保存，配合防氧化材料，减少表面发黑。',
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-20 14:56:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-20 16:26:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0069', '民国柏木髹漆经匣', 'WOOD', 'WOOD', '民国', '馆际调拨',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-22 15:03:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-22 16:33:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0070', '明代描金漆奁', 'LACQUER', 'LACQUER_WOOD', '明代', '旧藏移交',
  'STORAGE_ROOM_3', 'BASIC_COMPLETE', 'IN_STOCK', '一级', '避免阳光直射和湿热环境，表面禁止硬物摩擦。',
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-24 09:10:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-24 10:40:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0071', '北魏经幢立像', 'STONE', 'STONE', '北魏', '考古发掘入藏',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-26 10:17:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-26 11:47:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0072', '战国编联木牍', 'BAMBOO', 'BAMBOO_WOOD', '战国', '考古发掘入藏',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-28 11:24:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-28 12:54:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0074', '元代刻花罐', 'CERAMIC', 'CLAY', '元代', '征集购藏',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-02 13:38:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-02 15:08:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0077', '宋代累丝执壶', 'GOLD_SILVER_WARE', 'SILVER', '宋代', '社会捐赠',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-08 09:59:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-08 11:29:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0078', '清代描金经匣', 'WOOD', 'BAMBOO_WOOD', '清代', '寺院征集',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-10 10:06:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-10 11:36:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0079', '战国戗金漆盒', 'LACQUER', 'LACQUER_WOOD', '战国', '征集购藏',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-12 11:13:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-12 12:43:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0080', '北魏莲花座坐像', 'STONE', 'STONE', '北魏', '考古发掘入藏',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-14 12:20:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-14 13:50:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0081', '战国墨书木牍', 'BAMBOO', 'BAMBOO_WOOD', '战国', '考古发掘入藏',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-16 13:27:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-16 14:57:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0083', '元代影青盘口壶', 'CERAMIC', 'CLAY', '元代', '征集购藏',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-20 15:41:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-20 17:11:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0086', '唐代累丝带扣', 'GOLD_SILVER_WARE', 'SILVER', '唐代', '旧藏整理',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-26 11:02:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-26 12:32:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0087', '民国描金经匣', 'WOOD', 'BAMBOO_WOOD', '民国', '社会捐赠',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-28 12:09:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-28 13:39:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0088', '战国剔红漆奁', 'LACQUER', 'LACQUER_WOOD', '战国', '社会捐赠',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-30 13:16:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-30 14:46:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0089', '唐代菩萨坐像', 'STONE', 'STONE', '唐代', '考古发掘入藏',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-01 14:23:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-01 15:53:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0090', '宋代编联竹简', 'BAMBOO', 'BAMBOO_WOOD', '宋代', '学术移交',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-03 15:30:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-03 17:00:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0092', '清代白釉盘', 'CERAMIC', 'CLAY', '清代', '考古发掘入藏',
  'EXHIBIT_HALL_1', 'INCOMPLETE', 'IN_STOCK', '二级', '低震动环境保存，配合缓冲支撑，防止胎体继续开裂。',
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-07 10:44:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-07 12:14:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0095', '清代鎏金带扣', 'GOLD_SILVER_WARE', 'GOLD', '清代', '旧藏整理',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-13 13:05:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-13 14:35:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0096', '民国柏木髹漆经匣', 'WOOD', 'BAMBOO_WOOD', '民国', '社会捐赠',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-15 14:12:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-15 15:42:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0097', '明代戗金漆盘', 'LACQUER', 'LACQUER_WOOD', '明代', '旧藏移交',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-17 15:19:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-17 16:49:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0098', '唐代莲花座石刻残件', 'STONE', 'STONE', '唐代', '馆际移交',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-19 09:26:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-19 10:56:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0099', '明代墨书竹简', 'BAMBOO', 'BAMBOO_WOOD', '明代', '学术移交',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-21 10:33:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-21 12:03:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0101', '元代粉彩罐', 'CERAMIC', 'CLAY', '元代', '社会捐赠',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-25 12:47:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-25 14:17:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0104', '清代鎏金冠饰', 'GOLD_SILVER_WARE', 'SILVER', '清代', '馆际征集',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-31 15:08:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-31 16:38:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0105', '明代紫檀雕花佛像', 'WOOD', 'WOOD', '明代', '社会捐赠',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-02 09:15:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-02 10:45:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0106', '民国描金漆盘', 'LACQUER', 'LACQUER_WOOD', '民国', '旧藏移交',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-04 10:22:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-04 11:52:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0107', '北魏造像碑立像', 'STONE', 'STONE', '北魏', '寺院征集',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-06 11:29:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-06 12:59:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0108', '战国简牍竹简', 'BAMBOO', 'BAMBOO_WOOD', '战国', '馆际征集',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-08 12:36:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-08 14:06:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0110', '民国白釉罐', 'CERAMIC', 'PORCELAIN', '民国', '考古发掘入藏',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-12 14:50:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-12 16:20:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0113', '宋代鎏金带扣', 'GOLD_SILVER_WARE', 'GOLD', '宋代', '旧藏整理',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-18 10:11:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-18 11:41:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0114', '明代描金香几', 'WOOD', 'BAMBOO_WOOD', '明代', '寺院征集',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-20 11:18:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-20 12:48:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0115', '战国描金漆壶', 'LACQUER', 'LACQUER_WOOD', '战国', '社会捐赠',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-22 12:25:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-22 13:55:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0116', '北魏经幢坐像', 'STONE', 'STONE', '北魏', '馆际移交',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-24 13:32:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-24 15:02:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0117', '战国题记册页', 'BAMBOO', 'BAMBOO_WOOD', '战国', '考古发掘入藏',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-26 14:39:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-26 16:09:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0119', '元代影青碗', 'CERAMIC', 'PORCELAIN', '元代', '征集购藏',
  'LOC_A', 'COMPLETE', 'OUTBOUND_PENDING', '二级', '防震托架单件存放，避免温差突变与硬物碰撞。',
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-02 09:53:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-02 11:23:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0122', '清代掐丝带扣', 'GOLD_SILVER_WARE', 'SILVER', '清代', '旧藏整理',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-08 12:14:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-08 13:44:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0123', '清代描金香几', 'WOOD', 'BAMBOO_WOOD', '清代', '馆际调拨',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-10 13:21:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-10 14:51:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0124', '明代戗金漆盒', 'LACQUER', 'LACQUER_WOOD', '明代', '社会捐赠',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-12 14:28:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-12 15:58:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0125', '北魏莲花座坐像', 'STONE', 'STONE', '北魏', '寺院征集',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-14 15:35:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-14 17:05:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0126', '宋代编联卷册', 'BAMBOO', 'BAMBOO_WOOD', '宋代', '馆际征集',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-16 09:42:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-16 11:12:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0128', '宋代印花香炉', 'CERAMIC', 'CLAY', '宋代', '征集购藏',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-20 11:56:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-20 13:26:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0131', '唐代掐丝冠饰', 'GOLD_SILVER_WARE', 'SILVER', '唐代', '旧藏整理',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-26 14:17:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-26 15:47:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0132', '明代描金供案', 'WOOD', 'BAMBOO_WOOD', '明代', '社会捐赠',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-28 15:24:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-28 16:54:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0133', '战国戗金漆盘', 'LACQUER', 'LACQUER_WOOD', '战国', '社会捐赠',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-30 09:31:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-30 11:01:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0134', '唐代菩萨立像', 'STONE', 'STONE', '唐代', '考古发掘入藏',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-01 10:38:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-01 12:08:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0135', '汉代墨书册页', 'BAMBOO', 'BAMBOO_WOOD', '汉代', '学术移交',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-03 11:45:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-03 13:15:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0137', '元代粉彩香炉', 'CERAMIC', 'CLAY', '元代', '考古发掘入藏',
  ...
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-07 13:59:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-07 15:29:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0140', '唐代錾花银盘', 'GOLD_SILVER_WARE', 'GOLD', '唐代', '馆际征集',
  ...
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-13 09:20:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-13 10:50:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0141', '民国黄花梨佛像', 'WOOD', 'WOOD', '民国', '社会捐赠',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-15 10:27:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-15 11:57:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0142', '汉代黑漆漆壶', 'LACQUER', 'LACQUER_WOOD', '汉代', '征集购藏',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-17 11:34:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-17 13:04:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0143', '北魏莲花座供养人像', 'STONE', 'STONE', '北魏', '考古发掘入藏',
  ...
  '残碎件较多，需分件编号和托盘存放。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-19 12:41:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-19 14:11:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0144', '战国漆书卷册', 'BAMBOO', 'BAMBOO_WOOD', '战国', '考古发掘入藏',
  ...
  '注意霉斑、虫蛀等病害复发，需定期检查。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-21 13:48:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-21 15:18:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0146', '明代刻花香炉', 'CERAMIC', 'CLAY', '明代', '社会捐赠',
  ...
  '注意霉斑、虫蛀等病害复发，需定期检查。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-25 15:02:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-25 16:32:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0149', '宋代錾刻执壶', 'GOLD_SILVER_WARE', 'GOLD', '宋代', '社会捐赠',
  ...
  '残碎件较多，需分件编号和托盘存放。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-01 11:23:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-01 12:53:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0150', '明代黄花梨经匣', 'WOOD', 'WOOD', '明代', '社会捐赠',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-03 12:30:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-03 14:00:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0151', '明代黑漆漆壶', 'LACQUER', 'LACQUER_WOOD', '明代', '征集购藏',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-05 13:37:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-05 15:07:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0152', '唐代造像碑立像', 'STONE', 'STONE', '唐代', '馆际移交',
  ...
  '注意霉斑、虫蛀等病害复发，需定期检查。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-07 14:44:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-07 16:14:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0153', '汉代漆书卷册', 'BAMBOO', 'BAMBOO_WOOD', '汉代', '馆际征集',
  ...
  '注意霉斑、虫蛀等病害复发，需定期检查。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-09 15:51:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-09 17:21:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0155', '民国青花罐', 'CERAMIC', 'CLAY', '民国', '考古发掘入藏',
  ...
  '注意霉斑、虫蛀等病害复发，需定期检查。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-13 10:05:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-13 11:35:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0158', '清代錾刻银盘', 'GOLD_SILVER_WARE', 'SILVER', '清代', '社会捐赠',
  ...
  '注意霉斑、虫蛀等病害复发，需定期检查。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-19 13:26:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-19 14:56:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0159', '民国描金佛像', 'WOOD', 'BAMBOO_WOOD', '民国', '寺院征集',
  ...
  '存在裂缝或断口，禁止直接陈列与频繁移动。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-21 14:33:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-21 16:03:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0160', '汉代黑漆漆壶', 'LACQUER', 'LACQUER_WOOD', '汉代', '征集购藏',
  ...
  '注意霉斑、虫蛀等病害复发，需定期检查。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-23 15:40:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-23 17:10:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0161', '北魏佛首立像', 'STONE', 'STONE', '北魏', '考古发掘入藏',
  ...
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-25 09:47:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-25 11:17:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0162', '明代编联册页', 'BAMBOO', 'BAMBOO_WOOD', '明代', '馆际征集',
  ...
  '残碎件较多，需分件编号和托盘存放。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-27 10:54:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-27 12:24:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0164', '唐代刻花梅瓶', 'CERAMIC', 'PORCELAIN', '唐代', '社会捐赠',
  ...
  '存在裂缝或断口，禁止直接陈列与频繁移动。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-31 12:08:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-31 13:38:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0167', '宋代錾刻带扣', 'GOLD_SILVER_WARE', 'SILVER', '宋代', '旧藏整理',
  ...
  '需重点监测表面腐蚀、粉化或漆层脱落。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-06 15:29:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-06 16:59:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0168', '清代描金佛像', 'WOOD', 'WOOD', '清代', '馆际调拨',
  ...
  '结构脆弱，原则上仅允许修复评估与专项查看。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-08 09:36:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-08 11:06:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0182', '唐代刻花盘口壶', 'CERAMIC', 'PORCELAIN', '唐代', '考古发掘入藏',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-06 09:14:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-06 10:44:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0185', '唐代錾花银盘', 'GOLD_SILVER_WARE', 'GOLD', '唐代', '社会捐赠',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-12 12:35:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-12 14:05:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0186', '明代柏木髹漆佛像', 'WOOD', 'BAMBOO_WOOD', '明代', '社会捐赠',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-14 13:42:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-14 15:12:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0187', '战国黑漆漆壶', 'LACQUER', 'LACQUER_WOOD', '战国', '征集购藏',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-16 14:49:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-16 16:19:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0188', '北魏造像碑石刻残件', 'STONE', 'STONE', '北魏', '考古发掘入藏',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-18 15:56:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-18 17:26:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0189', '明代简牍竹简', 'BAMBOO', 'BAMBOO_WOOD', '明代', '考古发掘入藏',
  'LOC_VIP', 'INCOMPLETE', 'IN_STOCK', '二级', '防虫防霉，保持缓慢通风，搬运时使用托板支撑。',
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-20 09:03:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-20 10:33:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0191', '明代粉彩香炉', 'CERAMIC', 'PORCELAIN', '明代', '社会捐赠',
  ...
  '局部残缺，调阅与搬运需双人复核。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-24 11:17:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-24 12:47:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0194', '宋代錾花冠饰', 'GOLD_SILVER_WARE', 'GOLD', '宋代', '社会捐赠',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-30 14:38:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-30 16:08:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0195', '明代紫檀雕花佛像', 'WOOD', 'BAMBOO_WOOD', '明代', '馆际调拨',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-08-01 15:45:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-08-01 17:15:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0196', '明代朱漆漆盒', 'LACQUER', 'LACQUER_WOOD', '明代', '征集购藏',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-08-03 09:52:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-08-03 11:22:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0197', '宋代佛首石刻残件', 'STONE', 'STONE', '宋代', '寺院征集',
  ...
  '常规巡检即可，适合常设展陈或常规库房管理。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-08-05 10:59:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-08-05 12:29:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0198', '战国题记木牍', 'BAMBOO', 'BAMBOO_WOOD', '战国', '学术移交',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-08-07 11:06:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-08-07 12:36:00', 0
FROM DUAL
...
SELECT 'REL-DEMO-2026-0200', '元代印花香炉', 'CERAMIC', 'PORCELAIN', '元代', '社会捐赠',
  ...
  '搬运时需加缓冲垫，避免高频流转。', '用于馆藏建档、库存查询、出入库流转、修复跟踪和答辩演示的模拟馆藏文物档案。', '批量生成的测试数据，可用于分页、筛选、审批、盘点和修复流程联调。', '/uploads/demo/images/relic-placeholder.png', '/uploads/demo/reports/appraisal-note.txt',
  COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-08-11 13:20:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-08-11 14:50:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-001', 'BATCH-DEMO-2026-001', '旧藏整理建档', '王蕾', '2024-07-19 14:35:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-19 14:35:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-19 14:35:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-002', 'BATCH-DEMO-2026-002', '考古发掘入藏', '周洋', '2024-07-29 12:10:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-29 12:10:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-07-29 12:10:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-003', 'BATCH-DEMO-2026-003', '考古发掘入藏', '林清', '2024-08-08 10:45:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-08 10:45:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-08 10:45:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-004', 'BATCH-DEMO-2026-004', '社会征集入藏', '何远', '2024-08-18 15:20:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-18 15:20:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-18 15:20:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-005', 'BATCH-DEMO-2026-005', '旧藏整理建档', '苏瑶', '2024-08-28 13:55:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-28 13:55:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-08-28 13:55:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-006', 'BATCH-DEMO-2026-006', '社会征集入藏', '郑川', '2024-09-07 11:30:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-07 11:30:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-07 11:30:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-007', 'BATCH-DEMO-2026-007', '馆际调拨入藏', '宋宁', '2024-09-17 09:05:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-17 09:05:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-17 09:05:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-008', 'BATCH-DEMO-2026-008', '考古发掘入藏', '魏安', '2024-09-27 14:40:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-27 14:40:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-09-27 14:40:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-009', 'BATCH-DEMO-2026-009', '社会征集入藏', '唐蕾', '2024-10-07 12:15:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-07 12:15:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-07 12:15:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-010', 'BATCH-DEMO-2026-010', '社会征集入藏', '韩卓', '2024-10-17 10:50:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-17 10:50:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-17 10:50:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-011', 'BATCH-DEMO-2026-011', '专题征集入藏', '顾琳', '2024-10-27 15:25:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-27 15:25:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-10-27 15:25:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-012', 'BATCH-DEMO-2026-012', '社会征集入藏', '罗宁', '2024-11-06 13:00:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-06 13:00:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-06 13:00:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-013', 'BATCH-DEMO-2026-013', '馆际调拨入藏', '姚菲', '2024-11-16 11:35:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-16 11:35:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-16 11:35:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-014', 'BATCH-DEMO-2026-014', '馆际调拨入藏', '王蕾', '2024-11-26 09:10:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-26 09:10:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-11-26 09:10:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-015', 'BATCH-DEMO-2026-015', '专题征集入藏', '周洋', '2024-12-06 14:45:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-06 14:45:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-06 14:45:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-016', 'BATCH-DEMO-2026-016', '专题征集入藏', '林清', '2024-12-16 12:20:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-16 12:20:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-16 12:20:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-017', 'BATCH-DEMO-2026-017', '社会征集入藏', '何远', '2024-12-26 10:55:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-26 10:55:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2024-12-26 10:55:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-018', 'BATCH-DEMO-2026-018', '考古发掘入藏', '苏瑶', '2025-01-05 15:30:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-05 15:30:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-05 15:30:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-019', 'BATCH-DEMO-2026-019', '社会征集入藏', '郑川', '2025-01-15 13:05:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-15 13:05:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-15 13:05:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-020', 'BATCH-DEMO-2026-020', '专题征集入藏', '宋宁', '2025-01-25 11:40:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-25 11:40:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-01-25 11:40:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-021', 'BATCH-DEMO-2026-021', '社会征集入藏', '魏安', '2025-02-04 09:15:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-04 09:15:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-04 09:15:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-022', 'BATCH-DEMO-2026-022', '社会征集入藏', '唐蕾', '2025-02-14 14:50:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-14 14:50:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-14 14:50:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-023', 'BATCH-DEMO-2026-023', '旧藏整理建档', '韩卓', '2025-02-24 12:25:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-24 12:25:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-02-24 12:25:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-024', 'BATCH-DEMO-2026-024', '专题征集入藏', '顾琳', '2025-03-06 10:00:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-06 10:00:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-06 10:00:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-025', 'BATCH-DEMO-2026-025', '考古发掘入藏', '罗宁', '2025-03-16 15:35:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-16 15:35:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-16 15:35:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-026', 'BATCH-DEMO-2026-026', '专题征集入藏', '姚菲', '2025-03-26 13:10:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-26 13:10:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-03-26 13:10:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-027', 'BATCH-DEMO-2026-027', '社会征集入藏', '王蕾', '2025-04-05 11:45:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-05 11:45:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-05 11:45:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-028', 'BATCH-DEMO-2026-028', '考古发掘入藏', '周洋', '2025-04-15 09:20:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-15 09:20:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-15 09:20:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-029', 'BATCH-DEMO-2026-029', '专题征集入藏', '林清', '2025-04-25 14:55:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-25 14:55:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-04-25 14:55:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-030', 'BATCH-DEMO-2026-030', '馆际调拨入藏', '何远', '2025-05-05 12:30:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-05 12:30:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-05 12:30:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-031', 'BATCH-DEMO-2026-031', '考古发掘入藏', '苏瑶', '2025-05-15 10:05:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-15 10:05:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-15 10:05:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-032', 'BATCH-DEMO-2026-032', '考古发掘入藏', '郑川', '2025-05-25 15:40:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-25 15:40:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-25 15:40:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-033', 'BATCH-DEMO-2026-033', '考古发掘入藏', '宋宁', '2025-06-04 13:15:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-04 13:15:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-04 13:15:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-034', 'BATCH-DEMO-2026-034', '社会征集入藏', '魏安', '2025-06-14 11:50:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-14 11:50:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-14 11:50:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-035', 'BATCH-DEMO-2026-035', '馆际调拨入藏', '唐蕾', '2025-06-24 09:25:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-24 09:25:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-24 09:25:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-036', 'BATCH-DEMO-2026-036', '馆际调拨入藏', '韩卓', '2025-07-04 14:00:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-04 14:00:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-04 14:00:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-037', 'BATCH-DEMO-2026-037', '馆际调拨入藏', '顾琳', '2025-07-14 12:35:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-14 12:35:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-14 12:35:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-038', 'BATCH-DEMO-2026-038', '旧藏整理建档', '罗宁', '2025-07-24 10:10:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-24 10:10:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-24 10:10:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-039', 'BATCH-DEMO-2026-039', '专题征集入藏', '姚菲', '2025-08-03 15:45:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-08-03 15:45:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-08-03 15:45:00', 0
FROM DUAL
...
SELECT 'IN-DEMO-2026-040', 'BATCH-DEMO-2026-040', '旧藏整理建档', '王蕾', '2025-08-13 13:20:00', 5, 'COMPLETED',
  '批量生成的入藏建档单，共包含 5 件文物。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-08-13 13:20:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-08-13 13:20:00', 0
FROM DUAL
...
SELECT 'REP-DEMO-2026-001', r.id, 'REL-DEMO-2026-0154', '春秋蟠螭纹镜', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '存在裂隙与结构松动，需要进行加固处理。',
  'APPLIED', 'UNACCEPTED', '2025-06-08 09:58:00', NULL,
  NULL, NULL, NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-08 09:58:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-08 09:58:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0154' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-002', r.id, 'REL-DEMO-2026-0155', '民国青花罐', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '表层彩绘起翘，需要实施病害处置。',
  'APPLIED', 'UNACCEPTED', '2025-06-10 10:05:00', NULL,
  NULL, NULL, NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-10 10:05:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-10 10:05:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0155' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-003', r.id, 'REL-DEMO-2026-0156', '元代墨竹立轴', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '馆藏调阅中发现局部缺损，需要修复评估。',
  'APPLIED', 'UNACCEPTED', '2025-06-12 11:12:00', NULL,
  NULL, NULL, NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-12 11:12:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-12 11:12:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0156' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-004', r.id, 'REL-DEMO-2026-0157', '商代螭龙纹玉琮', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '长期存放后病害复发，需要重新修复。',
  'APPLIED', 'UNACCEPTED', '2025-06-14 12:19:00', NULL,
  NULL, NULL, NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-14 12:19:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-14 12:19:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0157' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-005', r.id, 'REL-DEMO-2026-0158', '清代錾刻银盘', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '器表腐蚀加重，需要开展清理与稳定性加固。',
  'APPLIED', 'UNACCEPTED', '2025-06-16 13:26:00', NULL,
  NULL, NULL, NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-16 13:26:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-16 13:26:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0158' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-006', r.id, 'REL-DEMO-2026-0159', '民国描金佛像', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '存在裂隙与结构松动，需要进行加固处理。',
  'APPLIED', 'UNACCEPTED', '2025-06-18 14:33:00', NULL,
  NULL, NULL, NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-18 14:33:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-18 14:33:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0159' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-007', r.id, 'REL-DEMO-2026-0160', '汉代黑漆漆壶', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '表层彩绘起翘，需要实施病害处置。',
  'APPLIED', 'UNACCEPTED', '2025-06-20 15:40:00', NULL,
  NULL, NULL, NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-20 15:40:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-20 15:40:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0160' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-008', r.id, 'REL-DEMO-2026-0161', '北魏佛首立像', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '馆藏调阅中发现局部缺损，需要修复评估。',
  'APPLIED', 'UNACCEPTED', '2025-06-22 09:47:00', NULL,
  NULL, NULL, NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-22 09:47:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-22 09:47:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0161' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-009', r.id, 'REL-DEMO-2026-0162', '明代编联册页', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '长期存放后病害复发，需要重新修复。',
  'APPLIED', 'UNACCEPTED', '2025-06-24 10:54:00', NULL,
  NULL, NULL, NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-24 10:54:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-24 10:54:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0162' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-010', r.id, 'REL-DEMO-2026-0163', '战国错金银带钩', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '器表腐蚀加重，需要开展清理与稳定性加固。',
  'APPLIED', 'UNACCEPTED', '2025-06-26 11:01:00', NULL,
  NULL, NULL, NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-26 11:01:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-26 11:01:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0163' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-011', r.id, 'REL-DEMO-2026-0164', '唐代刻花梅瓶', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '存在裂隙与结构松动，需要进行加固处理。',
  'APPROVED', 'UNACCEPTED', '2025-06-28 12:08:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-06-29 12:08:00', '审批通过，按方案推进修复。', NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-28 12:08:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-29 12:08:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0164' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-012', r.id, 'REL-DEMO-2026-0165', '清代仕女手卷', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '表层彩绘起翘，需要实施病害处置。',
  'APPROVED', 'UNACCEPTED', '2025-06-30 13:15:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-01 13:15:00', '审批通过，按方案推进修复。', NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-30 13:15:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-01 13:15:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0165' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-013', r.id, 'REL-DEMO-2026-0166', '商代素面玉璧', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '馆藏调阅中发现局部缺损，需要修复评估。',
  'APPROVED', 'UNACCEPTED', '2025-07-02 14:22:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-03 14:22:00', '审批通过，按方案推进修复。', NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-02 14:22:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-03 14:22:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0166' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-014', r.id, 'REL-DEMO-2026-0167', '宋代錾刻带扣', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '长期存放后病害复发，需要重新修复。',
  'APPROVED', 'UNACCEPTED', '2025-07-04 15:29:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-05 15:29:00', '审批通过，按方案推进修复。', NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-04 15:29:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-05 15:29:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0167' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-015', r.id, 'REL-DEMO-2026-0168', '清代描金佛像', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '器表腐蚀加重，需要开展清理与稳定性加固。',
  'APPROVED', 'UNACCEPTED', '2025-07-06 09:36:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-07 09:36:00', '审批通过，按方案推进修复。', NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-06 09:36:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-07 09:36:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0168' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-016', r.id, 'REL-DEMO-2026-0169', '民国剔红漆盘', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '存在裂隙与结构松动，需要进行加固处理。',
  'APPROVED', 'UNACCEPTED', '2025-07-08 10:43:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-09 10:43:00', '审批通过，按方案推进修复。', NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-08 10:43:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-09 10:43:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0169' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-017', r.id, 'REL-DEMO-2026-0170', '北魏莲花座石刻残件', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '表层彩绘起翘，需要实施病害处置。',
  'APPROVED', 'UNACCEPTED', '2025-07-10 11:50:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-11 11:50:00', '审批通过，按方案推进修复。', NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-10 11:50:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-11 11:50:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0170' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-018', r.id, 'REL-DEMO-2026-0136', '战国云雷纹带钩', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '馆藏调阅中发现局部缺损，需要修复评估。',
  'IN_PROGRESS', 'UNACCEPTED', '2025-05-03 12:52:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-05-04 12:52:00', '审批通过，按方案推进修复。', '2025-05-05 12:52:00', NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-03 12:52:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-05 12:52:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0136' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-019', r.id, 'REL-DEMO-2026-0137', '元代粉彩香炉', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '长期存放后病害复发，需要重新修复。',
  'IN_PROGRESS', 'UNACCEPTED', '2025-05-05 13:59:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-05-06 13:59:00', '审批通过，按方案推进修复。', '2025-05-07 13:59:00', NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-05 13:59:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-07 13:59:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0137' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-020', r.id, 'REL-DEMO-2026-0138', '清代墨竹册页', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '器表腐蚀加重，需要开展清理与稳定性加固。',
  'IN_PROGRESS', 'UNACCEPTED', '2025-05-07 14:06:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-05-08 14:06:00', '审批通过，按方案推进修复。', '2025-05-09 14:06:00', NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-07 14:06:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-09 14:06:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0138' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-021', r.id, 'REL-DEMO-2026-0139', '新石器时代云龙纹玉圭', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '存在裂隙与结构松动，需要进行加固处理。',
  'IN_PROGRESS', 'UNACCEPTED', '2025-05-09 15:13:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-05-10 15:13:00', '审批通过，按方案推进修复。', '2025-05-11 15:13:00', NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-09 15:13:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-11 15:13:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0139' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-022', r.id, 'REL-DEMO-2026-0140', '唐代錾花银盘', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '表层彩绘起翘，需要实施病害处置。',
  'IN_PROGRESS', 'UNACCEPTED', '2025-05-11 09:20:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-05-12 09:20:00', '审批通过，按方案推进修复。', '2025-05-13 09:20:00', NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-11 09:20:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-13 09:20:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0140' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-023', r.id, 'REL-DEMO-2026-0141', '民国黄花梨佛像', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '馆藏调阅中发现局部缺损，需要修复评估。',
  'IN_PROGRESS', 'UNACCEPTED', '2025-05-13 10:27:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-05-14 10:27:00', '审批通过，按方案推进修复。', '2025-05-15 10:27:00', NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-13 10:27:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-15 10:27:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0141' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-024', r.id, 'REL-DEMO-2026-0142', '汉代黑漆漆壶', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '长期存放后病害复发，需要重新修复。',
  'IN_PROGRESS', 'UNACCEPTED', '2025-05-15 11:34:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-05-16 11:34:00', '审批通过，按方案推进修复。', '2025-05-17 11:34:00', NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-15 11:34:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-17 11:34:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0142' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-025', r.id, 'REL-DEMO-2026-0143', '北魏莲花座供养人像', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '器表腐蚀加重，需要开展清理与稳定性加固。',
  'IN_PROGRESS', 'UNACCEPTED', '2025-05-17 12:41:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-05-18 12:41:00', '审批通过，按方案推进修复。', '2025-05-19 12:41:00', NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-17 12:41:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-19 12:41:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0143' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-026', r.id, 'REL-DEMO-2026-0144', '战国漆书卷册', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '存在裂隙与结构松动，需要进行加固处理。',
  'IN_PROGRESS', 'UNACCEPTED', '2025-05-19 13:48:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-05-20 13:48:00', '审批通过，按方案推进修复。', '2025-05-21 13:48:00', NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-19 13:48:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-21 13:48:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0144' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-027', r.id, 'REL-DEMO-2026-0145', '战国蟠螭纹镜', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '表层彩绘起翘，需要实施病害处置。',
  'IN_PROGRESS', 'UNACCEPTED', '2025-05-21 14:55:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-05-22 14:55:00', '审批通过，按方案推进修复。', '2025-05-23 14:55:00', NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-21 14:55:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-23 14:55:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0145' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-028', r.id, 'REL-DEMO-2026-0146', '明代刻花香炉', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '馆藏调阅中发现局部缺损，需要修复评估。',
  'COMPLETED', 'WAITING', '2025-05-23 15:02:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-05-24 15:02:00', '审批通过，按方案推进修复。', '2025-05-25 15:02:00', '2025-06-02 15:02:00',
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-23 15:02:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-02 15:02:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0146' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-029', r.id, 'REL-DEMO-2026-0147', '宋代仕女册页', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '长期存放后病害复发，需要重新修复。',
  'COMPLETED', 'WAITING', '2025-05-25 09:09:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-05-26 09:09:00', '审批通过，按方案推进修复。', '2025-05-27 09:09:00', '2025-06-05 09:09:00',
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-25 09:09:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-05 09:09:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0147' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-030', r.id, 'REL-DEMO-2026-0148', '战国凤鸟纹玉璧', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '器表腐蚀加重，需要开展清理与稳定性加固。',
  'COMPLETED', 'WAITING', '2025-05-27 10:16:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-05-28 10:16:00', '审批通过，按方案推进修复。', '2025-05-29 10:16:00', '2025-06-08 10:16:00',
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-27 10:16:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-08 10:16:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0148' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-031', r.id, 'REL-DEMO-2026-0149', '宋代錾刻执壶', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '存在裂隙与结构松动，需要进行加固处理。',
  'COMPLETED', 'WAITING', '2025-05-29 11:23:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-05-30 11:23:00', '审批通过，按方案推进修复。', '2025-05-31 11:23:00', '2025-06-11 11:23:00',
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-29 11:23:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-11 11:23:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0149' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-032', r.id, 'REL-DEMO-2026-0150', '明代黄花梨经匣', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '表层彩绘起翘，需要实施病害处置。',
  'COMPLETED', 'WAITING', '2025-05-31 12:30:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-06-01 12:30:00', '审批通过，按方案推进修复。', '2025-06-02 12:30:00', '2025-06-10 12:30:00',
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-05-31 12:30:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-10 12:30:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0150' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-033', r.id, 'REL-DEMO-2026-0151', '明代黑漆漆壶', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '馆藏调阅中发现局部缺损，需要修复评估。',
  'COMPLETED', 'WAITING', '2025-06-02 13:37:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-06-03 13:37:00', '审批通过，按方案推进修复。', '2025-06-04 13:37:00', '2025-06-13 13:37:00',
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher11' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-02 13:37:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-13 13:37:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0151' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-034', r.id, 'REL-DEMO-2026-0152', '唐代造像碑立像', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '长期存放后病害复发，需要重新修复。',
  'COMPLETED', 'WAITING', '2025-06-04 14:44:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-06-05 14:44:00', '审批通过，按方案推进修复。', '2025-06-06 14:44:00', '2025-06-16 14:44:00',
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher12' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-04 14:44:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-16 14:44:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0152' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-035', r.id, 'REL-DEMO-2026-0153', '汉代漆书卷册', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '器表腐蚀加重，需要开展清理与稳定性加固。',
  'COMPLETED', 'WAITING', '2025-06-06 15:51:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-06-07 15:51:00', '审批通过，按方案推进修复。', '2025-06-08 15:51:00', '2025-06-19 15:51:00',
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher13' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-06 15:51:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-06-19 15:51:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0153' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-036', r.id, 'REL-DEMO-2026-0171', '宋代编联竹简', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '存在裂隙与结构松动，需要进行加固处理。',
  'ACCEPTED', 'SUCCESS', '2025-07-12 12:57:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-13 12:57:00', '审批通过，按方案推进修复。', '2025-07-14 12:57:00', '2025-07-22 12:57:00',
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher14' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-12 12:57:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-22 12:57:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0171' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-037', r.id, 'REL-DEMO-2026-0172', '汉代云雷纹带钩', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '表层彩绘起翘，需要实施病害处置。',
  'ACCEPTED', 'SUCCESS', '2025-07-14 13:04:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-15 13:04:00', '审批通过，按方案推进修复。', '2025-07-16 13:04:00', '2025-07-25 13:04:00',
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher02' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-14 13:04:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-25 13:04:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0172' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-038', r.id, 'REL-DEMO-2026-0173', '元代粉彩香炉', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '馆藏调阅中发现局部缺损，需要修复评估。',
  'ACCEPTED', 'SUCCESS', '2025-07-16 14:11:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-17 14:11:00', '审批通过，按方案推进修复。', '2025-07-18 14:11:00', '2025-07-28 14:11:00',
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher03' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-16 14:11:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-28 14:11:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0173' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-039', r.id, 'REL-DEMO-2026-0174', '元代花鸟手卷', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '长期存放后病害复发，需要重新修复。',
  'ACCEPTED', 'SUCCESS', '2025-07-18 15:18:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-19 15:18:00', '审批通过，按方案推进修复。', '2025-07-20 15:18:00', '2025-07-31 15:18:00',
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher04' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-18 15:18:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-31 15:18:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0174' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-040', r.id, 'REL-DEMO-2026-0175', '商代谷纹带钩', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '器表腐蚀加重，需要开展清理与稳定性加固。',
  'ACCEPTED', 'SUCCESS', '2025-07-20 09:25:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-21 09:25:00', '审批通过，按方案推进修复。', '2025-07-22 09:25:00', '2025-07-30 09:25:00',
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher05' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-20 09:25:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-30 09:25:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0175' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-041', r.id, 'REL-DEMO-2026-0176', '清代掐丝香囊', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '存在裂隙与结构松动，需要进行加固处理。',
  'REJECTED', 'UNACCEPTED', '2025-07-22 10:32:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-23 10:32:00', '当前病害风险可控，建议先加强保管观察。', NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher06' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-22 10:32:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-23 10:32:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0176' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-042', r.id, 'REL-DEMO-2026-0177', '民国描金香几', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '表层彩绘起翘，需要实施病害处置。',
  'REJECTED', 'UNACCEPTED', '2025-07-24 11:39:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-25 11:39:00', '当前病害风险可控，建议先加强保管观察。', NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher07' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-24 11:39:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-25 11:39:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0177' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-043', r.id, 'REL-DEMO-2026-0178', '汉代剔红漆盒', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '馆藏调阅中发现局部缺损，需要修复评估。',
  'REJECTED', 'UNACCEPTED', '2025-07-26 12:46:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-27 12:46:00', '当前病害风险可控，建议先加强保管观察。', NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher08' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-26 12:46:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-27 12:46:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0178' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-044', r.id, 'REL-DEMO-2026-0179', '宋代造像碑供养人像', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '长期存放后病害复发，需要重新修复。',
  'REJECTED', 'UNACCEPTED', '2025-07-28 13:53:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-29 13:53:00', '当前病害风险可控，建议先加强保管观察。', NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher09' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-28 13:53:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-29 13:53:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0179' AND r.deleted = 0
...
SELECT 'REP-DEMO-2026-045', r.id, 'REL-DEMO-2026-0180', '明代编联竹简', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '器表腐蚀加重，需要开展清理与稳定性加固。',
  'REJECTED', 'UNACCEPTED', '2025-07-30 14:00:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id),
  '2025-07-31 14:00:00', '当前病害风险可控，建议先加强保管观察。', NULL, NULL,
  '批量生成的修复业务测试数据。', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher10' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-30 14:00:00', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-31 14:00:00', 0
FROM relic r
WHERE r.relic_no = 'REL-DEMO-2026-0180' AND r.deleted = 0
...
SELECT t.id, 'PLAN-DEMO-2026-001', '唐代刻花梅瓶清理与稳定化方案', '针对唐代刻花梅瓶当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '明胶、脱盐水、缓冲棉', '施工过程中需控制局部受力，避免二次损伤。', 'APPROVED',
  '王蕾', '李博', '2025-06-29 12:08:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-06-29 12:08:00', @seed_admin_id, '2025-06-29 12:08:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-002', '清代仕女手卷修复方案', '针对清代仕女手卷当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '支撑架、树脂材料、记录标签', '病害处置完成后需安排阶段性复核。', 'APPROVED',
  '周洋', '李博', '2025-07-01 13:15:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-07-01 13:15:00', @seed_admin_id, '2025-07-01 13:15:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-003', '商代素面玉璧清理与稳定化方案', '针对商代素面玉璧当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '支撑架、树脂材料、记录标签', '修复前后均需完成高清影像留存。', 'APPROVED',
  '林清', '李博', '2025-07-03 14:22:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-07-03 14:22:00', @seed_admin_id, '2025-07-03 14:22:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-004', '宋代錾刻带扣加固与补配方案', '针对宋代錾刻带扣当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '无酸纸、支撑纱、加固剂', '涉及彩绘与表面层的操作应减少接触频次。', 'APPROVED',
  '何远', '李博', '2025-07-05 15:29:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-07-05 15:29:00', @seed_admin_id, '2025-07-05 15:29:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-005', '清代描金佛像病害处置方案', '针对清代描金佛像当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '明胶、脱盐水、缓冲棉', '病害处置完成后需安排阶段性复核。', 'APPROVED',
  '苏瑶', '李博', '2025-07-07 09:36:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-07-07 09:36:00', @seed_admin_id, '2025-07-07 09:36:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-006', '民国剔红漆盘加固与补配方案', '针对民国剔红漆盘当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '明胶、脱盐水、缓冲棉', '修复前后均需完成高清影像留存。', 'APPROVED',
  '郑川', '李博', '2025-07-09 10:43:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-07-09 10:43:00', @seed_admin_id, '2025-07-09 10:43:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-007', '北魏莲花座石刻残件加固与补配方案', '针对北魏莲花座石刻残件当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '矿物颜料、保护胶、无纺布', '修复前后均需完成高清影像留存。', 'APPROVED',
  '宋宁', '李博', '2025-07-11 11:50:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-07-11 11:50:00', @seed_admin_id, '2025-07-11 11:50:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-008', '战国云雷纹带钩清理与稳定化方案', '针对战国云雷纹带钩当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '无酸纸、支撑纱、加固剂', '涉及彩绘与表面层的操作应减少接触频次。', 'APPROVED',
  '魏安', '李博', '2025-05-04 12:52:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-05-04 12:52:00', @seed_admin_id, '2025-05-04 12:52:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-009', '元代粉彩香炉加固与补配方案', '针对元代粉彩香炉当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '矿物颜料、保护胶、无纺布', '病害处置完成后需安排阶段性复核。', 'APPROVED',
  '唐蕾', '李博', '2025-05-06 13:59:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-05-06 13:59:00', @seed_admin_id, '2025-05-06 13:59:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-010', '清代墨竹册页加固与补配方案', '针对清代墨竹册页当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '矿物颜料、保护胶、无纺布', '涉及彩绘与表面层的操作应减少接触频次。', 'APPROVED',
  '韩卓', '李博', '2025-05-08 14:06:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-05-08 14:06:00', @seed_admin_id, '2025-05-08 14:06:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-011', '新石器时代云龙纹玉圭修复方案', '针对新石器时代云龙纹玉圭当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '矿物颜料、保护胶、无纺布', '涉及彩绘与表面层的操作应减少接触频次。', 'APPROVED',
  '顾琳', '李博', '2025-05-10 15:13:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-05-10 15:13:00', @seed_admin_id, '2025-05-10 15:13:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-012', '唐代錾花银盘修复方案', '针对唐代錾花银盘当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '无酸纸、支撑纱、加固剂', '涉及彩绘与表面层的操作应减少接触频次。', 'APPROVED',
  '罗宁', '李博', '2025-05-12 09:20:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-05-12 09:20:00', @seed_admin_id, '2025-05-12 09:20:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-013', '民国黄花梨佛像加固与补配方案', '针对民国黄花梨佛像当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '无酸纸、支撑纱、加固剂', '涉及彩绘与表面层的操作应减少接触频次。', 'APPROVED',
  '姚菲', '李博', '2025-05-14 10:27:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-05-14 10:27:00', @seed_admin_id, '2025-05-14 10:27:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-014', '汉代黑漆漆壶修复方案', '针对汉代黑漆漆壶当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '明胶、脱盐水、缓冲棉', '施工过程中需控制局部受力，避免二次损伤。', 'APPROVED',
  '王蕾', '李博', '2025-05-16 11:34:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-05-16 11:34:00', @seed_admin_id, '2025-05-16 11:34:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-015', '北魏莲花座供养人像清理与稳定化方案', '针对北魏莲花座供养人像当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '明胶、脱盐水、缓冲棉', '涉及彩绘与表面层的操作应减少接触频次。', 'APPROVED',
  '周洋', '李博', '2025-05-18 12:41:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-05-18 12:41:00', @seed_admin_id, '2025-05-18 12:41:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-016', '战国漆书卷册加固与补配方案', '针对战国漆书卷册当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '无酸纸、支撑纱、加固剂', '施工过程中需控制局部受力，避免二次损伤。', 'APPROVED',
  '林清', '李博', '2025-05-20 13:48:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-05-20 13:48:00', @seed_admin_id, '2025-05-20 13:48:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-017', '战国蟠螭纹镜清理与稳定化方案', '针对战国蟠螭纹镜当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '矿物颜料、保护胶、无纺布', '涉及彩绘与表面层的操作应减少接触频次。', 'APPROVED',
  '何远', '李博', '2025-05-22 14:55:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-05-22 14:55:00', @seed_admin_id, '2025-05-22 14:55:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-018', '明代刻花香炉病害处置方案', '针对明代刻花香炉当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '明胶、脱盐水、缓冲棉', '修复前后均需完成高清影像留存。', 'APPROVED',
  '苏瑶', '李博', '2025-05-24 15:02:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-05-24 15:02:00', @seed_admin_id, '2025-05-24 15:02:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-019', '宋代仕女册页加固与补配方案', '针对宋代仕女册页当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '矿物颜料、保护胶、无纺布', '病害处置完成后需安排阶段性复核。', 'APPROVED',
  '郑川', '李博', '2025-05-26 09:09:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-05-26 09:09:00', @seed_admin_id, '2025-05-26 09:09:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-020', '战国凤鸟纹玉璧加固与补配方案', '针对战国凤鸟纹玉璧当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '支撑架、树脂材料、记录标签', '施工过程中需控制局部受力，避免二次损伤。', 'APPROVED',
  '宋宁', '李博', '2025-05-28 10:16:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-05-28 10:16:00', @seed_admin_id, '2025-05-28 10:16:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-021', '宋代錾刻执壶清理与稳定化方案', '针对宋代錾刻执壶当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '明胶、脱盐水、缓冲棉', '修复前后均需完成高清影像留存。', 'APPROVED',
  '魏安', '李博', '2025-05-30 11:23:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-05-30 11:23:00', @seed_admin_id, '2025-05-30 11:23:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-022', '明代黄花梨经匣加固与补配方案', '针对明代黄花梨经匣当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '矿物颜料、保护胶、无纺布', '涉及彩绘与表面层的操作应减少接触频次。', 'APPROVED',
  '唐蕾', '李博', '2025-06-01 12:30:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-06-01 12:30:00', @seed_admin_id, '2025-06-01 12:30:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-023', '明代黑漆漆壶加固与补配方案', '针对明代黑漆漆壶当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '明胶、脱盐水、缓冲棉', '病害处置完成后需安排阶段性复核。', 'APPROVED',
  '韩卓', '李博', '2025-06-03 13:37:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-06-03 13:37:00', @seed_admin_id, '2025-06-03 13:37:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-024', '唐代造像碑立像加固与补配方案', '针对唐代造像碑立像当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '矿物颜料、保护胶、无纺布', '病害处置完成后需安排阶段性复核。', 'APPROVED',
  '顾琳', '李博', '2025-06-05 14:44:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-06-05 14:44:00', @seed_admin_id, '2025-06-05 14:44:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-025', '汉代漆书卷册病害处置方案', '针对汉代漆书卷册当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '明胶、脱盐水、缓冲棉', '病害处置完成后需安排阶段性复核。', 'APPROVED',
  '罗宁', '李博', '2025-06-07 15:51:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-06-07 15:51:00', @seed_admin_id, '2025-06-07 15:51:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-026', '宋代编联竹简病害处置方案', '针对宋代编联竹简当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '支撑架、树脂材料、记录标签', '修复前后均需完成高清影像留存。', 'APPROVED',
  '姚菲', '李博', '2025-07-13 12:57:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-07-13 12:57:00', @seed_admin_id, '2025-07-13 12:57:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-027', '汉代云雷纹带钩加固与补配方案', '针对汉代云雷纹带钩当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '支撑架、树脂材料、记录标签', '施工过程中需控制局部受力，避免二次损伤。', 'APPROVED',
  '王蕾', '李博', '2025-07-15 13:04:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-07-15 13:04:00', @seed_admin_id, '2025-07-15 13:04:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-028', '元代粉彩香炉修复方案', '针对元代粉彩香炉当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '支撑架、树脂材料、记录标签', '涉及彩绘与表面层的操作应减少接触频次。', 'APPROVED',
  '周洋', '李博', '2025-07-17 14:11:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-07-17 14:11:00', @seed_admin_id, '2025-07-17 14:11:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-029', '元代花鸟手卷清理与稳定化方案', '针对元代花鸟手卷当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '矿物颜料、保护胶、无纺布', '涉及彩绘与表面层的操作应减少接触频次。', 'APPROVED',
  '林清', '李博', '2025-07-19 15:18:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-07-19 15:18:00', @seed_admin_id, '2025-07-19 15:18:00', 0
FROM repair_task t
...
SELECT t.id, 'PLAN-DEMO-2026-030', '商代谷纹带钩病害处置方案', '针对商代谷纹带钩当前病害情况，拟采取清理、加固、补配、记录归档等步骤开展保护修复。', '矿物颜料、保护胶、无纺布', '修复前后均需完成高清影像留存。', 'APPROVED',
  '何远', '李博', '2025-07-21 09:25:00', '方案内容完整，可按计划执行。', @seed_admin_id, '2025-07-21 09:25:00', @seed_admin_id, '2025-07-21 09:25:00', 0
FROM repair_task t
...
SELECT t.id, 'LOG-DEMO-2026-001', '表面清理', '对表面浮尘、附着物进行低干预清理。', '无酸纸、支撑纱、加固剂', '魏安', '2025-05-05 12:52:00',
...
SELECT t.id, 'LOG-DEMO-2026-002', '结构加固', '针对脆弱部位开展加固处理并完成稳定性复核。', '明胶、脱盐水、缓冲棉', '魏安', '2025-05-06 12:52:00',
...
SELECT t.id, 'LOG-DEMO-2026-003', '结构加固', '针对脆弱部位开展加固处理并完成稳定性复核。', '矿物颜料、保护胶、无纺布', '唐蕾', '2025-05-07 13:59:00',
...
SELECT t.id, 'LOG-DEMO-2026-004', '颜色协调', '补录修复过程资料并形成归档说明。', '明胶、脱盐水、缓冲棉', '唐蕾', '2025-05-08 13:59:00',
...
SELECT t.id, 'LOG-DEMO-2026-005', '颜色协调', '补录修复过程资料并形成归档说明。', '矿物颜料、保护胶、无纺布', '韩卓', '2025-05-09 14:06:00',
...
SELECT t.id, 'LOG-DEMO-2026-006', '病害复核', '对表面浮尘、附着物进行低干预清理。', '支撑架、树脂材料、记录标签', '韩卓', '2025-05-10 14:06:00',
...
SELECT t.id, 'LOG-DEMO-2026-007', '病害复核', '对表面浮尘、附着物进行低干预清理。', '支撑架、树脂材料、记录标签', '顾琳', '2025-05-11 15:13:00',
...
SELECT t.id, 'LOG-DEMO-2026-008', '裂隙处理', '针对脆弱部位开展加固处理并完成稳定性复核。', '矿物颜料、保护胶、无纺布', '顾琳', '2025-05-12 15:13:00',
...
SELECT t.id, 'LOG-DEMO-2026-009', '裂隙处理', '针对脆弱部位开展加固处理并完成稳定性复核。', '矿物颜料、保护胶、无纺布', '罗宁', '2025-05-13 09:20:00',
...
SELECT t.id, 'LOG-DEMO-2026-010', '补配与校正', '补录修复过程资料并形成归档说明。', '无酸纸、支撑纱、加固剂', '罗宁', '2025-05-14 09:20:00',
...
SELECT t.id, 'LOG-DEMO-2026-011', '补配与校正', '补录修复过程资料并形成归档说明。', '无酸纸、支撑纱、加固剂', '姚菲', '2025-05-15 10:27:00',
...
SELECT t.id, 'LOG-DEMO-2026-012', '记录归档', '对表面浮尘、附着物进行低干预清理。', '矿物颜料、保护胶、无纺布', '姚菲', '2025-05-16 10:27:00',
...
SELECT t.id, 'LOG-DEMO-2026-013', '记录归档', '对表面浮尘、附着物进行低干预清理。', '无酸纸、支撑纱、加固剂', '王蕾', '2025-05-17 11:34:00',
...
SELECT t.id, 'LOG-DEMO-2026-014', '表面清理', '针对脆弱部位开展加固处理并完成稳定性复核。', '矿物颜料、保护胶、无纺布', '王蕾', '2025-05-18 11:34:00',
...
SELECT t.id, 'LOG-DEMO-2026-015', '表面清理', '针对脆弱部位开展加固处理并完成稳定性复核。', '明胶、脱盐水、缓冲棉', '周洋', '2025-05-19 12:41:00',
...
SELECT t.id, 'LOG-DEMO-2026-016', '结构加固', '补录修复过程资料并形成归档说明。', '无酸纸、支撑纱、加固剂', '周洋', '2025-05-20 12:41:00',
...
SELECT t.id, 'LOG-DEMO-2026-017', '结构加固', '补录修复过程资料并形成归档说明。', '矿物颜料、保护胶、无纺布', '林清', '2025-05-21 13:48:00',
...
SELECT t.id, 'LOG-DEMO-2026-018', '颜色协调', '对表面浮尘、附着物进行低干预清理。', '明胶、脱盐水、缓冲棉', '林清', '2025-05-22 13:48:00',
...
SELECT t.id, 'LOG-DEMO-2026-019', '颜色协调', '对表面浮尘、附着物进行低干预清理。', '无酸纸、支撑纱、加固剂', '何远', '2025-05-23 14:55:00',
...
SELECT t.id, 'LOG-DEMO-2026-020', '病害复核', '针对脆弱部位开展加固处理并完成稳定性复核。', '明胶、脱盐水、缓冲棉', '何远', '2025-05-24 14:55:00',
...
SELECT t.id, 'LOG-DEMO-2026-021', '病害复核', '针对脆弱部位开展加固处理并完成稳定性复核。', '无酸纸、支撑纱、加固剂', '苏瑶', '2025-05-25 15:02:00',
...
SELECT t.id, 'LOG-DEMO-2026-022', '裂隙处理', '补录修复过程资料并形成归档说明。', '明胶、脱盐水、缓冲棉', '苏瑶', '2025-05-26 15:02:00',
...
SELECT t.id, 'LOG-DEMO-2026-023', '补配与校正', '对表面浮尘、附着物进行低干预清理。', '矿物颜料、保护胶、无纺布', '苏瑶', '2025-05-27 15:02:00',
...
SELECT t.id, 'LOG-DEMO-2026-024', '结构加固', '完成病害点位复核并建立修复影像记录。', '矿物颜料、保护胶、无纺布', '郑川', '2025-05-27 09:09:00',
...
SELECT t.id, 'LOG-DEMO-2026-025', '颜色协调', '对裂隙与断口进行支撑固定和局部黏结。', '无酸纸、支撑纱、加固剂', '郑川', '2025-05-28 09:09:00',
...
SELECT t.id, 'LOG-DEMO-2026-026', '病害复核', '完成局部补配、校正与协调处理。', '无酸纸、支撑纱、加固剂', '郑川', '2025-05-29 09:09:00',
...
SELECT t.id, 'LOG-DEMO-2026-027', '记录归档', '针对脆弱部位开展加固处理并完成稳定性复核。', '无酸纸、支撑纱、加固剂', '宋宁', '2025-05-29 10:16:00',
...
SELECT t.id, 'LOG-DEMO-2026-028', '表面清理', '补录修复过程资料并形成归档说明。', '支撑架、树脂材料、记录标签', '宋宁', '2025-05-30 10:16:00',
...
SELECT t.id, 'LOG-DEMO-2026-029', '结构加固', '对表面浮尘、附着物进行低干预清理。', '支撑架、树脂材料、记录标签', '宋宁', '2025-05-31 10:16:00',
...
SELECT t.id, 'LOG-DEMO-2026-030', '裂隙处理', '完成病害点位复核并建立修复影像记录。', '明胶、脱盐水、缓冲棉', '魏安', '2025-05-31 11:23:00',
...
SELECT t.id, 'LOG-DEMO-2026-031', '补配与校正', '对裂隙与断口进行支撑固定和局部黏结。', '矿物颜料、保护胶、无纺布', '魏安', '2025-06-01 11:23:00',
...
SELECT t.id, 'LOG-DEMO-2026-032', '记录归档', '完成局部补配、校正与协调处理。', '矿物颜料、保护胶、无纺布', '魏安', '2025-06-02 11:23:00',
...
SELECT t.id, 'LOG-DEMO-2026-033', '颜色协调', '针对脆弱部位开展加固处理并完成稳定性复核。', '明胶、脱盐水、缓冲棉', '唐蕾', '2025-06-02 12:30:00',
...
SELECT t.id, 'LOG-DEMO-2026-034', '病害复核', '补录修复过程资料并形成归档说明。', '无酸纸、支撑纱、加固剂', '唐蕾', '2025-06-03 12:30:00',
...
SELECT t.id, 'LOG-DEMO-2026-035', '裂隙处理', '对表面浮尘、附着物进行低干预清理。', '明胶、脱盐水、缓冲棉', '唐蕾', '2025-06-04 12:30:00',
...
SELECT t.id, 'LOG-DEMO-2026-036', '表面清理', '完成病害点位复核并建立修复影像记录。', '明胶、脱盐水、缓冲棉', '韩卓', '2025-06-04 13:37:00',
...
SELECT t.id, 'LOG-DEMO-2026-037', '结构加固', '对裂隙与断口进行支撑固定和局部黏结。', '支撑架、树脂材料、记录标签', '韩卓', '2025-06-05 13:37:00',
...
SELECT t.id, 'LOG-DEMO-2026-038', '颜色协调', '完成局部补配、校正与协调处理。', '明胶、脱盐水、缓冲棉', '韩卓', '2025-06-06 13:37:00',
...
SELECT t.id, 'LOG-DEMO-2026-039', '补配与校正', '针对脆弱部位开展加固处理并完成稳定性复核。', '支撑架、树脂材料、记录标签', '顾琳', '2025-06-06 14:44:00',
...
SELECT t.id, 'LOG-DEMO-2026-040', '记录归档', '补录修复过程资料并形成归档说明。', '无酸纸、支撑纱、加固剂', '顾琳', '2025-06-07 14:44:00',
...
SELECT t.id, 'LOG-DEMO-2026-041', '表面清理', '对表面浮尘、附着物进行低干预清理。', '明胶、脱盐水、缓冲棉', '顾琳', '2025-06-08 14:44:00',
...
SELECT t.id, 'LOG-DEMO-2026-042', '病害复核', '完成病害点位复核并建立修复影像记录。', '支撑架、树脂材料、记录标签', '罗宁', '2025-06-08 15:51:00',
...
SELECT t.id, 'LOG-DEMO-2026-043', '裂隙处理', '对裂隙与断口进行支撑固定和局部黏结。', '矿物颜料、保护胶、无纺布', '罗宁', '2025-06-09 15:51:00',
...
SELECT t.id, 'LOG-DEMO-2026-044', '补配与校正', '完成局部补配、校正与协调处理。', '无酸纸、支撑纱、加固剂', '罗宁', '2025-06-10 15:51:00',
...
SELECT t.id, 'LOG-DEMO-2026-045', '结构加固', '针对脆弱部位开展加固处理并完成稳定性复核。', '无酸纸、支撑纱、加固剂', '姚菲', '2025-07-14 12:57:00',
...
SELECT t.id, 'LOG-DEMO-2026-046', '颜色协调', '补录修复过程资料并形成归档说明。', '无酸纸、支撑纱、加固剂', '姚菲', '2025-07-15 12:57:00',
...
SELECT t.id, 'LOG-DEMO-2026-047', '病害复核', '对表面浮尘、附着物进行低干预清理。', '矿物颜料、保护胶、无纺布', '姚菲', '2025-07-16 12:57:00',
...
SELECT t.id, 'LOG-DEMO-2026-048', '记录归档', '完成病害点位复核并建立修复影像记录。', '明胶、脱盐水、缓冲棉', '王蕾', '2025-07-16 13:04:00',
...
SELECT t.id, 'LOG-DEMO-2026-049', '表面清理', '对裂隙与断口进行支撑固定和局部黏结。', '无酸纸、支撑纱、加固剂', '王蕾', '2025-07-17 13:04:00',
...
SELECT t.id, 'LOG-DEMO-2026-050', '结构加固', '完成局部补配、校正与协调处理。', '无酸纸、支撑纱、加固剂', '王蕾', '2025-07-18 13:04:00',
...
SELECT t.id, 'LOG-DEMO-2026-051', '裂隙处理', '针对脆弱部位开展加固处理并完成稳定性复核。', '矿物颜料、保护胶、无纺布', '周洋', '2025-07-18 14:11:00',
...
SELECT t.id, 'LOG-DEMO-2026-052', '补配与校正', '补录修复过程资料并形成归档说明。', '支撑架、树脂材料、记录标签', '周洋', '2025-07-19 14:11:00',
...
SELECT t.id, 'LOG-DEMO-2026-053', '记录归档', '对表面浮尘、附着物进行低干预清理。', '矿物颜料、保护胶、无纺布', '周洋', '2025-07-20 14:11:00',
...
SELECT t.id, 'LOG-DEMO-2026-054', '颜色协调', '完成病害点位复核并建立修复影像记录。', '矿物颜料、保护胶、无纺布', '林清', '2025-07-20 15:18:00',
...
SELECT t.id, 'LOG-DEMO-2026-055', '病害复核', '对裂隙与断口进行支撑固定和局部黏结。', '无酸纸、支撑纱、加固剂', '林清', '2025-07-21 15:18:00',
...
SELECT t.id, 'LOG-DEMO-2026-056', '裂隙处理', '完成局部补配、校正与协调处理。', '矿物颜料、保护胶、无纺布', '林清', '2025-07-22 15:18:00',
...
SELECT t.id, 'LOG-DEMO-2026-057', '表面清理', '针对脆弱部位开展加固处理并完成稳定性复核。', '矿物颜料、保护胶、无纺布', '何远', '2025-07-22 09:25:00',
...
SELECT t.id, 'LOG-DEMO-2026-058', '结构加固', '补录修复过程资料并形成归档说明。', '无酸纸、支撑纱、加固剂', '何远', '2025-07-23 09:25:00',
...
SELECT t.id, 'LOG-DEMO-2026-059', '颜色协调', '对表面浮尘、附着物进行低干预清理。', '支撑架、树脂材料、记录标签', '何远', '2025-07-24 09:25:00',
...
SELECT t.id, 'ACC-DEMO-2026-001', 'PASS', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-22 18:57:00', '修复质量符合馆藏验收要求，可转入常规保管。', '建议三个月后复核病害稳定性并补录阶段性照片。',
...
SELECT t.id, 'ACC-DEMO-2026-002', 'PASS', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-25 19:04:00', '修复质量符合馆藏验收要求，可转入常规保管。', '建议三个月后复核病害稳定性并补录阶段性照片。',
...
SELECT t.id, 'ACC-DEMO-2026-003', 'PASS', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-28 20:11:00', '修复质量符合馆藏验收要求，可转入常规保管。', '建议三个月后复核病害稳定性并补录阶段性照片。',
...
SELECT t.id, 'ACC-DEMO-2026-004', 'PASS', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-31 21:18:00', '修复质量符合馆藏验收要求，可转入常规保管。', '建议三个月后复核病害稳定性并补录阶段性照片。',
...
SELECT t.id, 'ACC-DEMO-2026-005', 'PASS', COALESCE((SELECT id FROM sys_user WHERE username = 'researcher' AND deleted = 0 LIMIT 1), @seed_admin_id), '2025-07-30 15:25:00', '修复质量符合馆藏验收要求，可转入常规保管。', '建议三个月后复核病害稳定性并补录阶段性照片。',
