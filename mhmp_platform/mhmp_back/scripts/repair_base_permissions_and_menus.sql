...
INSERT INTO tmp_menu_seed (
    ...
    ('inventory', '发起转存', 'inventory:transfer', 'MENU', '/inventory/transfer', NULL, 'inventory:transfer:view', 34, 1, 'ENABLED', 'RefreshRight', 1, 'Base menu repair'),
    ('inventory', '我的转存', 'inventory:transfer:my', 'MENU', '/inventory/transfer/my', NULL, 'inventory:transfer:my:view', 35, 1, 'ENABLED', 'Finished', 1, 'Base menu repair'),
    ...
    ('inventory', '盘点任务', 'inventory:task', 'MENU', '/inventory/task', NULL, 'inventory:task:view', 36, 1, 'ENABLED', 'Checked', 1, 'Base menu repair'),
    ('inventory', '我的盘点', 'inventory:task:my', 'MENU', '/inventory/task/my', NULL, 'inventory:task:view', 37, 1, 'ENABLED', 'List', 1, 'Base menu repair'),
