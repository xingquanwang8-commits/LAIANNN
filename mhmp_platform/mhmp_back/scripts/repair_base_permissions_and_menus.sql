...
INSERT INTO tmp_menu_seed (
    ...
    ('inventory', '出库归还', 'inventory:outbound-return', 'MENU', '/inventory/outbound/return', NULL, 'inventory:outbound:return:view', 34, 1, 'ENABLED', 'RefreshLeft', 1, 'Base menu repair'),
    ('inventory', '发起转存', 'inventory:transfer', 'MENU', '/inventory/transfer', NULL, 'inventory:transfer:view', 35, 1, 'ENABLED', 'RefreshRight', 1, 'Base menu repair'),
    ('inventory', '我的转存', 'inventory:transfer:my', 'MENU', '/inventory/transfer/my', NULL, 'inventory:transfer:my:view', 36, 1, 'ENABLED', 'Finished', 1, 'Base menu repair'),
    ('inventory', '盘点任务', 'inventory:task', 'MENU', '/inventory/task', NULL, 'inventory:task:view', 37, 1, 'ENABLED', 'Checked', 1, 'Base menu repair'),
    ('inventory', '我的盘点', 'inventory:task:my', 'MENU', '/inventory/task/my', NULL, 'inventory:task:view', 38, 1, 'ENABLED', 'List', 1, 'Base menu repair'),
    ...
    ('inventory:outbound-return', '出库归还登记', 'inventory:outbound:return', 'BUTTON', NULL, NULL, 'inventory:outbound:return', 1, 1, 'ENABLED', NULL, 0, 'Base permission repair'),
    ('inventory:transfer', '转存任务派发', 'inventory:transfer:add', 'BUTTON', NULL, NULL, 'inventory:transfer:add', 1, 1, 'ENABLED', NULL, 0, 'Base permission repair'),
    ('inventory:transfer:my', '确认转存', 'inventory:transfer:confirm', 'BUTTON', NULL, NULL, 'inventory:transfer:confirm', 1, 1, 'ENABLED', NULL, 0, 'Base permission repair'),
...
INSERT IGNORE INTO tmp_role_menu_seed (role_code, menu_code) VALUES
    ...
    ('researcher', 'inventory:transfer:my'),
...
INSERT IGNORE INTO tmp_role_menu_seed (role_code, menu_code) VALUES
    ...
    ('senior_researcher', 'inventory:outbound-return'),
    ('senior_researcher', 'inventory:transfer'),
    ...
    ('senior_researcher', 'inventory:task:my'),
    ...
    ('senior_researcher', 'inventory:outbound:return'),
    ('senior_researcher', 'inventory:transfer:add'),
